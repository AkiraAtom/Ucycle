 ...
 * @version 1.0
 */
public class reseGoMainAction extends ActionSupport implements SessionAware {
	/**
	 * @author Saitoh Jumpei
	...
	public String execute() {
		...
		/* 実際に各項目を引き出し 変数に代入を行う*/
			...
			DBcustomerFamilyName = dao.DBcustomerFamilyName;
			DBcustomerGivenName = dao.DBcustomerGivenName;
			...
			System.out.println(dao.DBcustomerFamilyName);
			System.out.println(dao.DBcustomerGivenName);
